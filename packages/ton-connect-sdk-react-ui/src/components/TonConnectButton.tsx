import { type CSSProperties, type FunctionComponent, memo, useEffect } from "react";
...
const TonConnectButton: FunctionComponent<TonConnectButtonProps> = ({ className, style }) => {
  ...
  return <div id={buttonRootId} className={className} style={{ width: "fit-content", ...style }} />;
};
